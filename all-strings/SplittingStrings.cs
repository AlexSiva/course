...
namespace Strings
{
    public static class SplittingStrings
    {
        ...
        {
            var a = new char[1] { '-' };
            return str.Split(a, 3, StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        {
            var a = new char[2] { ':', ',' };
            return str.Split(a, 4, StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        {
            var a = new char[6] { ':', ',', '!', '\t', '.', '-' };
            return str.Split(a, StringSplitOptions.RemoveEmptyEntries);
        }
